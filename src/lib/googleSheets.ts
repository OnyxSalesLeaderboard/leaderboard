...
class GoogleSheetsService {
  ...
  constructor() {
    ...
    if (!process.env.GOOGLE_PRIVATE_KEY || !process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL) {
      throw new Error('Google service account credentials not found. Please set GOOGLE_PRIVATE_KEY, GOOGLE_PRIVATE_KEY_ID, and GOOGLE_SERVICE_ACCOUNT_EMAIL environment variables.');
    }
